...
@Component({
  ...
  imports: [PageBreadcrumbComponent, ButtonComponent,ModalComponent,  CommonModule, SafeHtmlPipe, InputFieldComponent, QrCodeComponent, SwitchComponent],
...
export class LoyaltyProgramsComponent implements OnInit {
  ...
  public memberName: string = 'BurgerLion';
  public stamps: number = 2;
  public maxStamps: number = 8;
  public qrCodeUrl: string = 'images/image.png'; 
  public signupLink: string = 'https://signup.happywallet.at/?loyaltyProgram=ea1ak121n1';

  public addIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>`
  ...
  switchActiveness(checked: boolean, card: any) {
    card.attributes.active = checked;
    this.dataService.updateLoyaltyProgram(card);
  }

  updateLoyaltyProgram(card: any){
  ...
  handleDeleteCard() {
    this.dataService.deleteLoyaltyProgram(this.deleteCard.id).then(() => {
      this.dataService.getLoyaltyPrograms();
      this.deleteCardToggle = false;
